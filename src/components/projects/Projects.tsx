...
import mtp from "../../images/projects/mtp.jpg";
    ...
    <Container maxWidth="xl">
      <section className="projects-container">
        <ProjectsCard
          ...
          description={`Molecular dynamics simulations are depened on interatomic potentials to descibe the movement of atoms as classical particles. Quantum chemistry technqiues like Density Functional Theory provide an accurate but infeasibly expensive solution. Machine learning potentials can provide practical prediction models through training on quantum mechanical datasets. As part of the Queen's Nuclear Group, datasets are generated and processed on Compute Canada HPC clusters. Subsequent active and passive training of an MTP model is used to generated a potassium metal model which is validated against DFT results and physical property prediciton.`}
